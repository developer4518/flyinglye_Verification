...
const HotelBooking = () => {
  ...
  const validateGuests = () => {
    ...
    // For corporate bookings, only the single Corporate PAN is required.
    ...
    for (let i = 0; i < guestList.length; i++) {
      ...
      // Passenger PAN fields are validated only for retail bookings.
      // Corporate bookings use one Corporate PAN entered above.
  ...
  const handleReviewBooking = () => {
    ...
    try {
      ...
      const cleanedGuests = guestList.map((g) => {
        ...
        if (isCorporate) {
          // The customer enters Corporate PAN only once. The same PAN is
          // automatically attached to every adult passenger in the API payload.
          // Child passengers are sent without a PAN field.
          if (g.PaxType === 1) {
              ...
              <label className="flex cursor-pointer items-start gap-3">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (checked) {
                      // Hide and clear passenger PAN values because only one
                      // Corporate PAN is entered by the customer.
                      setGuestList((prev) =>
                        prev.map((guest) => ({
                          ...guest,
                          PAN: "",
                  ...
                  className="mt-1 h-5 w-5 cursor-pointer accent-yellow-400"
                />
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-400">
                    Select this checkbox when booking for a corporate customer.
                  </p>
                </div>
              </label>
              ...
              {isCorporate && (
                <div className="mt-5 max-w-xl">
                  ...
                  <p className="mt-2 text-xs text-gray-500">
                    Enter the PAN once. It will be used automatically for all
                    adult passengers in this corporate booking.
                  </p>
                </div>
              )}
            </div>
            ...
            >
              ...
              {validation.PanMandatory && !isCorporate && (
                <p className="mt-3 text-xs text-gray-500">
                  {guest.PaxType === 2
                    ? "For child passengers, provide either the child's PAN or a Parent/Guardian PAN."
